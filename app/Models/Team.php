...
{
    protected $fillable = ['user_id', 'member_id', 'hourly_rate', 'currency', 'non_monetary', 'is_employee', 'enable_clockin', 'clockin_pin', 'clockout_duration'];
